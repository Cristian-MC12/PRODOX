 ...
 * PRODOX/Agile/Proyecto/Sprint/Métricas/Mejora continua. Se usa ANTES de construir historial,
 ...
 *    SIEMPRE, incluso si también menciona una palabra del dominio PRODOX (ej. "cuéntame un
 *    chiste sobre el sprint" sigue siendo fuera de dominio).
 * 2. Si contiene un término explícito del dominio PRODOX, se acepta.
...
public class CopilotDomainGuard {
    ...
    /**
     * Términos explícitos del dominio PRODOX/Agile. Lista centralizada: agregar aquí cualquier
     ...
     * @return true si el mensaje pertenece al dominio PRODOX (o es ambiguo/corto dentro de
