...
class JwtUtilTest {
    ...
    void generateToken_datosValidos_retornaToken() {
        String token = jwtUtil.generateToken("uuid-123", "user@prodox.com", "scrum_master");
    ...
    void getEmail_tokenValido_retornaEmail() {
        String token = jwtUtil.generateToken("uuid-123", "user@prodox.com", "scrum_master");
        assertThat(jwtUtil.getEmail(token)).isEqualTo("user@prodox.com");
    }
    ...
    void generateToken_conNombre_getNombreLoExtrae() {
        String token = jwtUtil.generateToken("uuid-123", "user@prodox.com", "scrum_master", "Juan Pérez");
    ...
    void isValid_tokenValido_retornaTrue() {
        String token = jwtUtil.generateToken("uuid-123", "user@prodox.com", "scrum_member");
    ...
    void isValid_tokenExpirado_retornaFalse() {
        ...
        String expiredToken = expiredUtil.generateToken("uuid", "user@prodox.com", "scrum_member");
