package com.prodox.integration;
 ...
 * - Requiere base de datos con datos reales de PRODOX
 * - Solo READ-ONLY, no modifica datos
 * 
 * EJECUCIÓN MANUAL:
 * 1. Verificar que prodox.gemini.api-key está configurada
