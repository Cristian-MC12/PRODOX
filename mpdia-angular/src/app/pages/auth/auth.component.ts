  ...
  styles: [`
    * {
    ...
    .login-container::after {
      ...
      bottom: 30%;
      right: 25%;
      animation: floatDots 5s ease-in-out infinite 1s;
    ...
    .floating-dot:nth-child(1) {
      ...
      top: 15%;
      left: 45%;
      animation: floatDots 6s ease-in-out infinite 0.5s;
    ...
    .floating-dot:nth-child(2) {
      ...
      top: 60%;
      left: 30%;
      animation: floatDots 7s ease-in-out infinite 1.5s;
    ...
    .floating-dot:nth-child(3) {
      ...
      top: 40%;
      right: 15%;
      animation: floatDots 5.5s ease-in-out infinite 2s;
      box-shadow: 0 0 20px rgba(99, 102, 241, 0.85);
    }
    ...
    .floating-dot:nth-child(4) {
      ...
      top: 75%;
      left: 50%;
      animation: floatDots 6.5s ease-in-out infinite 2.5s;
      box-shadow: 0 0 15px rgba(196, 181, 253, 0.9);
    }
    ...
    .floating-dot:nth-child(5) {
      ...
      bottom: 20%;
      left: 20%;
      animation: floatDots 7.5s ease-in-out infinite 3s;
      box-shadow: 0 0 19px rgba(124, 58, 237, 0.85);
    }
    ...
    .floating-dot:nth-child(6) {
      ...
      top: 25%;
      right: 35%;
      animation: floatDots 6s ease-in-out infinite 0.8s;
      box-shadow: 0 0 21px rgba(109, 40, 217, 0.9);
    }
